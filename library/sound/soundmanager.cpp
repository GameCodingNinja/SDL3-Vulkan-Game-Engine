...
/************************************************************************
*    DESC:  Initialize the audio device
************************************************************************/
void CSoundMgr::init()
{
    ...
    SDL_AudioSpec spec = {
        ...
        .channels = CSettings::Instance().getSoundChannels(), // mono, stero, quad, suround, etc
        .freq = CSettings::Instance().getFrequency()};        // Usually 22050 or 44100
...
/************************************************************************
*    DESC:  Stop, free and close the audio device
************************************************************************/
